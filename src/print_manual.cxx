...
void unvm::PrintManual()
{
    std::cerr
            ...
            << "  execute, exec, x <version> [-y|--yes] -- ...                  Execute the given command within the context of the specified Node.js version. Use `-y` or `--yes` to skip confirmation on auto-installing missing versions.\n"
            << "\n"
            << "Examples:\n"
            << "  unvm ?\n"
            << "  unvm install lts\n"
